...
myCodeImmersivesObj.objectify = 'Nick';
...
Myself.fullName = me.firstName + ' ' + me.lastName;
...
Myself.push('Pizza', 'Tech', 'Pi');

// Now make a new object, but this time we'll pre-populate it, not set it in any lines below it. In other words, the properties
// should be set the same way I initially set the `codeImmersivesObject` on line 1. It can be called whatever you want and can 
// have whatever properties you want, as long as they include at least one string value, boolean value, number value, and array
// of numbers. The important thing here is: this should all be done within the brackets of the object, not below the place where
